...
#	emacs -batch --load ~/.emacs.d/init.el $^  --funcall org-babel-tangle
#	emacs -batch --load ~/.emacs.d/init.el --eval "(setq enable-local-eval t)" --eval "(setq enable-local-variables t)" \
